...
ggtitle("Scatter plot of Agerage Beauty Rating to Average Evaluation Score")
```
...
***For average beauty increased by 1 the average evaluation rating.  Goes up by 0.07***
...
7.  Interpret the intercept of the linear model in context of the data.
  ...
  ***For and average beauty rating of 0 the average evaluation rating is 3.88.  This doesn't make sense in the data as there are not beauty ratings that are 0. ***
...
***A male subject on average scores 0.14 higher on evaluations than a female. 
On average a female professor scores 4.09 on the ratings.***
...
$$\widehat{score}_i = 4.28 - 0.12\times TenureTrack - 0.14\times Tenured_i$$
...
***In his lecture, Professor Sullivan said to leave this question blank.***
